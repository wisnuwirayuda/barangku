...
@section('body')
    <section>
        <div class="container my-4">
            <div class="mt-3">
                <form action="{{ route('officer.create.form') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama-barang') is-invalid @enderror" id="nama-barang" name="nama-barang" placeholder="Masukkan Nama Barang" value="{{ old('nama-barang') }}" autocomplete="off" autofocus>
                            @error('nama-barang')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" placeholder="Masukkan Alamat"></textarea>
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama-bank') is-invalid @enderror" id="nama-bank" name="nama-bank" placeholder="Masukkan Nama Bank" value="{{ old('nama-bank') }}">
                            @error('nama-bank')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
